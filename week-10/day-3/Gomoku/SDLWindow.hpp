...
public:
  ...
  bool game_logic_at_client(Map&, Player&, Scan&, bool&, Client_cl&);
  bool game_logic_at_server(Map&, Player&, Scan&, bool&, Server_sr&);
  bool enemy_at_client(Map&, Scan&, bool&, Client_cl&);
  bool enemy_at_server(Map&, Scan&, bool&, Server_sr&);
  void drawbackground();
